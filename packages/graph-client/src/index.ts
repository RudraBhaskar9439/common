...
export { assessDelivery, checkRequirement, deriveCapabilities, describePayload, CAPABILITY_PROBES } from './capabilities.js';
export type { CapabilityProbe, DeliveryAssessment, DerivedCapabilities, PayloadShape, RequirementCheck } from './capabilities.js';
